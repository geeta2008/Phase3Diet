...
@Test
@CucumberOptions(
		features = "src/test/resources/features/PutMorbidityFeatures/PutMorbidityAPI.feature", 
		...
		// strict = true,
		publish = true)
public class PutMorbidity extends io.cucumber.testng.AbstractTestNGCucumberTests {
	/*
	 * @Override
	 * 
