...
public class MorbidAPI_MorbidityIdStepDef {
	...
	public void for_morbidity_id_get_request_the_authorization_is_set_to_basic_auth_with_servers_running() {

		RestAssured.baseURI = ApplicationHook.prop.getProperty("baseURI");
		RestAssured.basePath = ApplicationHook.prop.getProperty("MorbidityTestID_basePath_valid"); 
	...
	@Then("User checks for {int}  Ok and")
	public void user_checks_for_ok_and(Integer statusCode, io.cucumber.datatable.DataTable dataTable) {
	...
	public void for_morbidity_id_get_request_the_invalid_authorization_is_set_to_basic_auth_with_servers_running() {
	...
	public void for_morbidity_id_get_request_the_authorization_is_set_to_basic_auth_and_invalid_endpoints_servers_running() {

		RestAssured.baseURI = ApplicationHook.prop.getProperty("baseURI");
		RestAssured.basePath = ApplicationHook.prop.getProperty("MorbidityTestID_basePath_invalid"); 
		getrequest = given().auth().preemptive().basic(ApplicationHook.prop.getProperty("username_valid"), ApplicationHook.prop.getProperty("password_valid")).contentType("application/json");
	...
	public void for_morbidity_id_get_request_the_authorization_is_set_to_basic_auth_with_servers_not_running() {
