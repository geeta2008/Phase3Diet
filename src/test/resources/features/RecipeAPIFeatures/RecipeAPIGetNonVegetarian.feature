...
@testNonvegvalid @Functional @Smoke
...
@TestNonvegInvalidparameter @Functional @Smoke
...
@TestNonvegunauthorized @Functional @Smoke
...
@TestNonVegInvalidendpoint @Functional @Smoke
