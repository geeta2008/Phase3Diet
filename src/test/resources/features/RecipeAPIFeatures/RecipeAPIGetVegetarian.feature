...
@GetRecipeVegValid @Functional @Smoke
...
@GetRecipeVegInvalid @Functional @Smoke
...
@GetRecipeVegUnauthorized @Functional @Smoke
...
@GetRecipeVegInvalidendpoint @Functional @Smoke 
